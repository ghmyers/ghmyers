...
![Simplified Conceptual Model of Floodplain DO Dynamics](figures/transfer_learning_LSTM.png)
***Conceptual model of weight freezing strategies during transfer learning finetuning of an LSTM model.***
